package com.anramirez.microserviciosmotoservice.controller;
...
import com.anramirez.microserviciosmotoservice.service.MotoService;
...
public class MotoControlador {
	...
	public ResponseEntity<List<Moto>> listarCochesPorUsuariosId(@PathVariable("usuarioId") int usuarioId) {
